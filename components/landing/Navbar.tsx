                ...
                <div className="mx-auto max-w-6xl rounded-full border border-white/10 bg-black/40 backdrop-blur-xl backdrop-saturate-150 px-6 py-3 shadow-lg shadow-black/20">
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/" className="flex items-center gap-2">
                            ...
                            <span className="text-base font-semibold italic text-white tracking-tight">Bingify</span>
                        </Link>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <button className="rounded-full border border-white/20 bg-white/5 px-5 py-2 text-sm font-medium text-white hover:bg-white/10 transition-colors">
                                Sign up
                            </button>
                        </div>
                    </div>
