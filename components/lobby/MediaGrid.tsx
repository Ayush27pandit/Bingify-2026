      ...
      {items.map((item, index) => {
        ...
        return (
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
            className={`group relative cursor-pointer rounded-xl overflow-hidden transition-all duration-300 ${isSelected
          ...
          >
            ...
            <div className="aspect-[2/3] relative bg-zinc-800" >
              <Image
                ...
                alt={item.title}
                fill
                className={`object-cover transition-opacity duration-300 ${isSelected
                  ? "opacity-100"
